...
# My note: this should be what I use within the mine_block, need to investigate further... this will allow me to calc time to mine not time between blocks as currently programmed.
for i in range(1000):
